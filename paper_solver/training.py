...
# %% auto 0
__all__ = ['train_dataset', 'eval_dataset', 'TEST_SIZE', 'PROJECT_HOME', 'INPUT_PATH', 'OUTPUT_PATH', 'files', 'zip_dir_name',
           'images', 'words', 'bboxes', 'ner_tags', 'image_path', 'labels', 'id2label', 'label2id', 'dataset_dict',
           'features', 'full_data_set', 'dataset', 'processor', 'column_names', 'image_column_name', 'text_column_name',
           'boxes_column_name', 'label_column_name', 'read_text_file', 'prepare_examples', 'get_zip_dir_name',
           'filter_out_unannotated']
...
TEST_SIZE = 0.33
PROJECT_HOME = Path('..')/Path('..')
INPUT_PATH = PROJECT_HOME/Path('papers/annotations/doc-scanner/')
OUTPUT_PATH = PROJECT_HOME/Path('preprocessed/')
OUTPUT_PATH.mkdir(parents=True, exist_ok=True)

# %% ../nbs/00_training.ipynb 17
files = {}
